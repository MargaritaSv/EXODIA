...
public class DocumentServiceImp implements DocumentService {
    ...
    @Autowired
    public DocumentServiceImp(DocumentRepository documentRepository, ModelMapper modelMapper) {
    ...
    public DocumentServiceModel findDocumentById(String id) {
        ...
        return this.modelMapper.map(doc, DocumentServiceModel.class);
    }
    ...
    @Override
    public boolean printDocumentsById(String id) {
